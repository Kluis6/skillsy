...
export function BlockedClient() {
  ...
  return (
    <div className="min-h-screen bg-surface flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-card rounded-xl p-8 md:p-10 shadow-lg border border-border-subtle text-center">
        <div className="w-20 h-20 bg-destructive/10 rounded-xl flex items-center justify-center mx-auto mb-8">
        ...
        <div className="space-y-4 mb-10">
          <a 
            ...
            className="flex items-center justify-center gap-3 p-4 bg-surface rounded-xl text-text-main font-semibold hover:bg-primary/5 transition-colors"
          >
          ...
          <button 
            ...
            className="flex items-center justify-center gap-3 p-4 bg-surface rounded-xl text-text-main font-semibold hover:bg-success/10 transition-colors w-full border-none cursor-pointer"
          >
