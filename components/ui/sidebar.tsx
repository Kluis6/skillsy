  ...
  if (isMobile) {
    return (
      ...
      <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="max-w-none bg-sidebar p-0 text-sidebar-foreground data-[side=left]:w-(--sidebar-width-mobile) data-[side=right]:w-(--sidebar-width-mobile) [&>button]:hidden"
          side={side}
        >
