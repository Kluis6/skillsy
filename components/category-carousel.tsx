...
const categories = [
  ...
  { name: "Design", icon: Palette, color: "text-primary", bg: "bg-primary/10" },
  {
    name: "Marketing",
    icon: Megaphone,
    color: "text-primary",
  ...
  { name: "Doméstico", icon: Home, color: "text-primary", bg: "bg-primary/10" },
  { name: "Limpeza", icon: Sparkles, color: "text-primary", bg: "bg-primary/10" },
  {
    name: "Marcenaria",
    icon: Sofa,
    color: "text-primary",
  ...
  { name: "Beleza", icon: Scissors, color: "text-primary", bg: "bg-primary/10" },
  {
    name: "Educação",
    icon: GraduationCap,
    color: "text-primary",
  ...
  { name: "Jurídico", icon: Scale, color: "text-primary", bg: "bg-primary/10" },
  {
    name: "Financeiro",
    icon: Coins,
    color: "text-primary",
  ...
  { name: "Automotivo", icon: Car, color: "text-primary", bg: "bg-primary/10" },
  { name: "Moda", icon: Shirt, color: "text-primary", bg: "bg-primary/10" },
  { name: "Bem Estar", icon: Heart, color: "text-primary", bg: "bg-primary/10" },
  { name: "Pet Care", icon: Dog, color: "text-primary", bg: "bg-primary/10" },
  {
    name: "Fotografia",
    icon: Camera,
    color: "text-primary",
            ...
            >
              {categories.map((cat, idx) => (
                <motion.button
                  ...
                  className="group/card flex min-w-[100px] shrink-0 flex-col items-center justify-between space-y-6 border bg-card p-4 transition-all duration-300  hover:shadow-md md:min-w-[140px]"
                >
                  <div
                    className={`size-12 md:size-14 lg:size-16 ${cat.bg} flex items-center justify-center transition-transform duration-300 group-hover/card:scale-110`}
                  >
