...
export function CategoryCarousel() {
  ...
  return (
    <div className="relative group container mx-auto px-4  mb-12">
      <div className="border dark:border-slate-800 p-4 md:p-8 rounded-xl shadow-xl bg-white dark:bg-neutral-950">
        ...
        >
          {categories.map((cat, idx) => (
            <motion.button
              ...
              className="flex flex-col items-center justify-center min-w-[100px] space-y-4 md:min-w-[120px] p-4 bg-card rounded-3xl border  hover:shadow-md  transition-all duration-300 group/card shrink-0"
            >
              <div
