  ...
  const benefits = [
    {
      ...
      description: 'Conecte-se com pessoas que valorizam honestidade, respeito e bom atendimento em cada contato.',
      icon: ShieldCheck,
      color: 'text-primary',
      bg: 'bg-primary/5',
    },
    {
      ...
      description: 'Mostre seu trabalho para pessoas da sua cidade e arredores que buscam indicações mais confiáveis.',
      icon: Zap,
      color: 'text-accent',
      bg: 'bg-accent/5',
    },
    {
      ...
      description: 'Receba avaliações de quem contratou você e ajude outros usuários a tomar decisões com mais segurança.',
      icon: Star,
    ...
    },
    {
      ...
      description: 'Mais do que fechar um serviço, você constrói relacionamentos profissionais que podem gerar novas oportunidades.',
      icon: Users,
      color: 'text-blue-500',
      bg: 'bg-blue-50',
    },
    {
      ...
      description: 'Quem presta um bom serviço encontra espaço para crescer. Quem contrata encontra ajuda com mais proximidade e afinidade.',
      icon: Trophy,
    ...
    },
    {
      ...
      description: 'Quando talentos locais se apoiam, todos ganham: profissionais, famílias e a comunidade ao redor.',
      icon: Heart,
      color: 'text-red-500',
      bg: 'bg-red-50',
    }
      ...
      <main className="mx-auto container px-4">
            ...
            <div className="max-w-3xl">
              ...
              >
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-[10px] font-bold uppercase tracking-widest mb-6">
                  <CheckCircle2 size={12} /> Cadastro gratuito para servir, crescer e se conectar
                </div>
                <h1 className="text-5xl md:text-7xl font-black text-text-main leading-tight mb-8">
                  Seu trabalho pode <span className="text-primary italic">fortalecer</span> uma comunidade inteira.
                </h1>
                <p className="text-xl text-text-muted leading-relaxed mb-10">
                  No Skillsy, você encontra e oferece serviços em um ambiente guiado por confiança, respeito e apoio mútuo. Cadastre-se para divulgar seu talento, encontrar pessoas com valores semelhantes e criar conexões que fortalecem a vida prática de todos.
                </p>
                <p className="text-sm text-text-muted leading-relaxed mb-10 max-w-2xl">
                  Iniciativa independente criada por membros da comunidade. O Skillsy não é afiliado nem representa oficialmente A Igreja de Jesus Cristo dos Santos dos Últimos Dias.
                </p>
        ...
        <section className="py-24 bg-surface/40">
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            <div className="text-center max-w-2xl mx-auto mb-20">
              <h2 className="text-3xl md:text-4xl font-bold text-text-main mb-6">Por que participar do Skillsy</h2>
              <p className="text-text-muted">Fazer parte do Skillsy ajuda você a encontrar oportunidades, contratar com mais confiança e manter o apoio circulando dentro da própria comunidade.</p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-20 items-center">
              <div className="flex-1 space-y-8">
                <h2 className="text-4xl font-black text-text-main leading-tight">
                  Pronto para <br />
                  <span className="text-accent underline decoration-4 underline-offset-8">fazer parte?</span>
                </h2>
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <p className="text-text-muted"><strong className="text-text-main">Crie seu perfil:</strong> Apresente quem você é, o que você faz e como pode ajudar.</p>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <p className="text-text-muted"><strong className="text-text-main">Encontre ou seja encontrado:</strong> Procure profissionais de confiança ou deixe seu perfil visível para novas oportunidades.</p>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <p className="text-text-muted"><strong className="text-text-main">Fortaleça sua reputação:</strong> Entregue um bom trabalho, receba avaliações e construa confiança ao longo do tempo.</p>
                  </div>
                </div>
                <AuthModal>
        ...
        <section className="py-24 bg-primary text-white text-center">
          <div className="max-w-3xl mx-auto px-6">
             <h2 className="text-4xl font-black mb-6">Trabalho, confiança e serviço também fortalecem a comunidade.</h2>
             <p className="text-primary-foreground/80 text-lg mb-10">
               Ao entrar no Skillsy, você ajuda a transformar habilidades em apoio real. Cada contratação bem-feita gera oportunidades, aproxima pessoas e fortalece uma rede de valores que beneficia todos.
             </p>
             <AuthModal>
